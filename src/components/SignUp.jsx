      ...
      <div className="w-full flex-1 mt-22 px-2">
        ...
        <div className="flex flex-col text-white">
          ...
          >
            ...
            <label className="text-white font-medium text-sm mb-4 mt-4" htmlFor="email">Email:</label>
            <input
              className="w-full px-8 py-4 font-medium bg-[#676f9d] border border-[#676f9d] placeholder-[#434769] text-sm focus:outline-none focus:border-[#f9b17a] focus:bg-[#414769]"
              type="email"
              name="email"
            ...
            {message && (
              <p className="px-2 text-sm text-[#f9b17a] font-medium bg-[#2d3250] transform translate-y-1/2">
                {message}
              </p>
            )}
          </form>
        ...
        <div className="px-2 text-sm text-white font-medium bg-[#2d3250] transform translate-y-1/2 mt-4">
          Use social media
